...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between mx-auto max-w-3xl bg-[#ceba9c] dark:bg-slate-800 rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-60 p-3">
          <Typical
