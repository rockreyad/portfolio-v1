...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between mx-auto max-w-3xl bg-[#ceba9c]  dark:bg-slate-800 bg-opacity-60 dark:bg-opacity-60 rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-sm dark:backdrop-blur-md p-3">
          <div className="flex justify-start items-center">
            ...
            <TypeAnimation
              sequence={[
                "Mahamud",
                500,
                "Mahamud Hasan", //  Continuing previous Text
                500,
                "Mahamud",
                500,
                "",
