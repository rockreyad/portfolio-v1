      ...
      <div className="grid sm grid-cols-1 grid-rows-2 gap-10  md:grid-cols-2 md:grid-rows-1">
        ...
        <div className="row-span-1 w-full">
          <div className="flex flex-col items-center justify-center text-gray-300 space-y-4 w-fit">
            <div className="">
              <h1 className="text-[#576F72] dark:text-gray-200 uppercase md:text-[0.55rem] text-sm font-semibold font-Din tracking-[.2rem] ">
                dont be a stranger
              </h1>
            </div>
          ...
          <div className="text-gray-300 ">
            <div className="flex flex-col items-start md:items-end justify-start md:justify-end text-gray-300 space-y-4">
              ...
              <h3 className="text-[#576F72] dark:text-white text-3xl md:text-sm font-[900] font-MarkPro hover:text-rose-500 dark:hover:text-rose-500">
                <a href="mailto:hasan.jsdev@gmail.com">Tell me about it</a>
              </h3>
            </div>
          </div>
        </div>
